...
namespace {
    ...
    define('LARAVEL_URL', 'localhost/websites/edoc-api/public/api/auth');
    define('BRIDGEBB_API_KEY', 'edockey'); // Api key
...
namespace laravel\bridgebb\auth\provider {
    ...
    class bridgebb extends \phpbb\auth\provider\base
    {
        ...
        {
            if(isset($_SESSION["token_laravel"]) && $_SESSION["token_laravel"]!=""){
        ...
        private function _makeApiRequest($data,$method) {
            ...
            if($method == 'GET'){
                ...
                $authorization = "Authorization: Bearer {".$_SESSION["token_laravel"]."}";
        ...
        private function _handleAuthSuccess($username, $password, $user_laravel)
        {
            ...
            $_SESSION["token_laravel"]=$user_laravel["token_laravel"];
